...
public class NewGame extends JFrame {
	 ...
	 * and shows the number of minions and buildings according to player color
	 */
	public void setRegionInfo() {
		for (int i = 0; i <= 11; i++) {
			...
			Region_Info.setValueAt(GameEngine.regionObjList.get(i).rNumber, i, 1);
			Region_Info.setValueAt(GameEngine.regionObjList.get(i).rBuildingCost, i, 2);
		...
		// ======== panel1 ========
		{
			...
			// ======== scrollPane2 ========
			{
				...
				Region_Info.setModel(new DefaultTableModel(new Object[][] {
						{ "Dolly Sisters", null, null, null, null, null, null, null },
						{ "Unreal Estate", null, null, null, null, null, null, null },
						{ "Dragon's Landing", null, null, null, null, null, null, null },
						{ "Small Gods", null, null, null, null, null, null, null },
						{ "The Scours", null, null, null, null, null, null, null },
						{ "The Hippo", null, null, null, null, null, null, null },
						{ "The Shades", null, null, null, null, null, null, null },
						{ "Dimwell", null, null, null, null, null, null, null },
						{ "Longwall", null, null, null, null, null, null, null },
						{ "Isle of Gods", null, null, null, null, null, null, null },
						{ "Seven Sleepers", null, null, null, null, null, null, null },
						{ "Nap Hill", null, null, null, null, null, null, null }, },
						new String[] { "Region",  "Region Number",  "Building Cost", "No. Of Minions",
