...
public class TestPlayerCards {
	 ...
	 */
	@Test
	public void testtakePlayerCard(){
		try{						
			obj1.setTurn(1);
			obj1.setPNumber(2);			
			obj2.setTurn(0);
			beforeCall = obj1.getPCards().size();
			List<String> Cards = new ArrayList<>();
			Cards = obj2.getPCards();
			obj.takePlayerCard(1, Cards.get(2));
			afterCall = obj1.getPCards().size();
			assertTrue(beforeCall != afterCall);
